...
import { getNewPath, initialState } from "redux/igcSecondary";
...
const IGC = () => {
  ...
  const igcCalc = useAppSelector((state) => state.igcSecondaryCalc);
            ...
            <StyledTable size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  ...
                  <StyledTableCellBorderLeft align="center" colSpan={2}>
                    Potência (kcal/min)
                  </StyledTableCellBorderLeft>
